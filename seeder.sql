...
VALUES ('I love the chicken sandwich.  It was just the right level of heat.' ,5 ,1 , 1 ),
       ('The birria had an odd flavor.  Not bad but different that what I normally expect.',4 , 1,2 ),
       ('Was driving through Ft Worth and decided to try this out.  The homemade spam was out of this world.' ,5 , 1 ,3),
       ('Had not seen a place that sold huaraches.  They were only ok.  Not enough beans to my liking.',3 , 1 ,4),
       ('Had never had bulgogi before and I don\'t think I will again.',1 ,1 ,5);
